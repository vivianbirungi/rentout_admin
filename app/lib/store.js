...
const useRLStore = create(persist((set,get) => ({
        properties: [],
        tenants: [],
        landLords: [],
        subscriptions: [],
        ...
        getProperties: async() => {
            ...
            // const results = useHttpGet('get_Properties');
        ...
        getSubscriptions: async() =>  {
            const results = await instance.get('get_Properties');
            set((state) => ({ ...state, properties: results}))},
        ...
        setActiveProperty: (propertyId) => {
            let property = get().properties.find(property => property.prop_id === propertyId);
